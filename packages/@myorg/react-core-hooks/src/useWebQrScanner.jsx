...
import { ScannerOverlay } from './QrScannerOverlay.jsx'
import { showToast } from './showToast.jsx'

/* =====================================================================
 * 摄像头扫码（命令式弹窗，非 React Hook）
 *
...
// 兼容旧 API：历史上以 useWebQrScanner 名字导出。
// 它并非 React Hook（内部不使用任何 Hook），仅是命令式「拉起扫码弹窗」函数。
export { openQrScanner as useWebQrScanner }
